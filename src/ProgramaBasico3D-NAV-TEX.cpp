...
void init(void)
{
    glClearColor(0.3f, 0.4f, 0.0f, 1.0f); // Fundo de tela preto
    ...
    LoadTexture ("CROSS.jpg"); // esta serah a textura 2
...
void display( void )
{
	...
	glPushMatrix();
        ...
        glRotatef(angulo,0,1,0);
		glColor3f(0.5f,0.2f,0.0f); // Vermelho
        //glutSolidCube(2);
        DesenhaCubo(2);
	glPopMatrix();

    // Exibe poligonos com texturas
    DesenhaPlacas();
